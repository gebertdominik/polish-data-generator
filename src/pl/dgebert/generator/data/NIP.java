...
public class NIP implements Document{

	RandomDataGen rdc = new RandomDataGen();
	...
	public String generate() {
		...
		do{
			...
			nip += String.valueOf(rdc.randBetween(100000, 999999));
	...
	private int getRandomDepartmentCode(){
		int result = departmentCodes[rdc.randBetween(0, departmentCodes.length - 1)];
		return result;
	}
